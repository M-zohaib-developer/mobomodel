...
export function OrderTrackingPage({ onNavigate }: OrderTrackingPageProps) {
  ...
  const filteredDevices = clientDevices.filter(
    (device) =>
  ...
  const getStatusSteps = (currentStatus: string) => {
    const steps = [
      ...
      },
      {
        ...
        description: "Device cleaning and final inspection",
      },
      {
        id: "completed",
        label: "Completed",
                    ...
                    <div className="mb-4">
                      ...
                      <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                        <div
                          ...
                          style={{
                            width: `${getProgressPercentage(device.status)}%`,
                          }}
                        ></div>
                      </div>
                    </div>
