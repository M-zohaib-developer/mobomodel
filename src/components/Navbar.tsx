...
import { Home, Package, Plus, Search, FileText, Users, Settings, LogOut, Smartphone } from 'lucide-react';
...
export function Navbar({ onNavigate }: NavbarProps) {
  ...
  const { currentPage, settings, currentUser } = state;
  ...
  const getNavItems = () => {
    ...
    switch (currentUser.role) {
      ...
      case 'enterprise':
        return [
          ...commonItems.slice(0, 1),
          { id: 'bulk-order', label: 'Bulk Order', icon: Package },
