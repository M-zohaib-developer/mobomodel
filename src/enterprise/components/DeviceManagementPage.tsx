      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
          {[
            {
              label: "Total",
              count: enterpriseDevices.length,
              color: "text-blue-600",
            },
            {
              label: "Pending",
              count: enterpriseDevices.filter((d) => d.status === "pending")
                .length,
              color: "text-gray-600",
            },
            {
              label: "In QC",
              count: enterpriseDevices.filter((d) => d.status === "qc").length,
              color: "text-yellow-600",
            },
            {
              label: "With Technician",
              count: enterpriseDevices.filter(
                (d) => d.status === "technician-diagnosis"
              ).length,
              color: "text-blue-600",
            },
            {
              label: "Completed",
              count: enterpriseDevices.filter((d) => d.status === "completed")
                .length,
