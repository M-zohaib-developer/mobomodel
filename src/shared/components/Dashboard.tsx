...
//             ["qc", "technician-diagnosis", "cleaning"].includes(d.status)
//           ).length,
//           completed: clientDevices.filter((d) => d.status === "completed")
//             .length,
//           orders: clientOrders.length,
//         };
//       case "enterprise":
//         const enterpriseDevices = devices.filter(
//           (d) => d.clientId === currentUser.id
//         );
...
//           pending: enterpriseDevices.filter((d) => d.status === "pending")
//             .length,
//           inProgress: enterpriseDevices.filter((d) =>
//             ["qc", "technician-diagnosis", "cleaning"].includes(d.status)
//           ).length,
//           completed: enterpriseDevices.filter((d) => d.status === "completed")
//             .length,
...
//           {
//             label: "Bulk Order",
//             action: () => onNavigate("bulk-order"),
//             color: "bg-green-600 hover:bg-green-700",
//           },
//           {
//             label: "Manage Devices",
//             action: () => onNavigate("device-management"),
//             color: "bg-blue-600 hover:bg-blue-700",
//           },
//         ];
//       case "admin":
...
//               "Manage your bulk device orders and track progress"}
//             {currentUser?.role === "admin" &&
//               "Oversee all operations and manage the system"}
//           </p>
//         </div>
